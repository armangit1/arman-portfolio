    ...
    return (
        <div id='skills' className='mt-20' >
            <div data-aos="flip-left"  className='mt-10 mx-2'>
                <h1 className='md:text-6xl text-3xl text-center  text-[#A074F9] mt-10'>My Skills</h1>
            ...
            <div className='grid lg:grid-cols-4 md:grid-cols-2 mt-10 p-5 gap-8 pb-10'>
                
                <div  data-aos="zoom-in" className='border-[#3c2d5c] hover:bg-[#2A1454] group bg-[#0F0715] border hover:border-[#543a8b] flex justify-center items-center hover:shadow-sm hover:shadow-[#A074F9] duration-300 py-4 mt-3 rounded-2xl'>
